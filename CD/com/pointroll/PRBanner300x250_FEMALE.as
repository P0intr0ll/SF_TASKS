package com.pointroll 
{
	 ...
	 */
	public class PRBanner300x250_FEMALE extends PRBannerMain 
	{
		
		public function PRBanner300x250_FEMALE() 
		{
			super();
		}
		...
		override protected function loadAllAssets():void {
			...
			queue.append( new ImageLoader(assetPath + "_300x2500_bnr_fr__0002_2f.png", 
							{ name:"2", container:this.BG_mc, alpha:0, scaleMode:"proportionalInside" } ) );
				
			queue.append( new ImageLoader(assetPath + "_300x2500_bnr_fr__0003_3f.png", 
							{ name:"3", container:this.BG_mc, alpha:0, scaleMode:"proportionalInside" } ) );
				
			//queue.append( new ImageLoader(assetPath + "_300x2500_bnr_fr__0005_4f.png", 
