package com.pointroll 
{
	 ...
	 */
	public class PRBanner160x600_MALE extends PRBannerMain 
	{
		
		public function PRBanner160x600_MALE() 
		{
			super();
		}
		...
		override protected function loadAllAssets():void {
			...
			queue.append( new ImageLoader(assetPath + "_160x600_bnr_fr__0001_2m.png", 
							{ name:"2", container:this.BG_mc, alpha:0, scaleMode:"proportionalInside" } ) );
				
			queue.append( new ImageLoader(assetPath + "_160x600_bnr_fr__0002_3m.png", 
							{ name:"3", container:this.BG_mc, alpha:0, scaleMode:"proportionalInside" } ) );
				
			//queue.append( new ImageLoader(assetPath + "_160x600_bnr_fr__0003_4m.png", 
